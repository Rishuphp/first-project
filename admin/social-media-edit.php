            ...
            <?= alertMessage(); ?>
                <form action="code.php" method="POST">
                    ...
                    if($socialMedia){
                        ...
                        <input type="next" name="name" value="<?= $socialMedia['data']['name']?>" required class="form-control"/>
                    </div>
                    <div class="mb-3">
                        <label>Social Media URL/LINK</label>
                        <input type="next" name="url" value="<?= $socialMedia['data']['url']?>"required class="form-control"/>
                    </div>
                    <div class="mb-3">
                        <label>Status</label>
                        <br/>
